    ...
    <div>
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" rel="noreferrer" href="https://haider-yf.sentry.io/issues/?project=4511326900846592">Issues Page</a>. 
